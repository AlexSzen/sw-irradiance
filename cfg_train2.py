...
if __name__ == "__main__":
    ...
    for cfgi,cfgPath in enumerate(cfgs):
        ...
        if cfg['arch'] == "resnet_18":
            ...
            sw_net = alt_models.AugResnet(resnet, 14, cfg['dropout'])
        else:
        ...
        EVE_path = '/home/szenicer/FDL/sw2018-irradiance/EVE/eve_future/future_36h_average_6h_6m/irradiance_future_36h_average_6h_6m.npy'
#'/scratch/EVE/irradiance.npy'

        #now this should saturate the gpus
        data_root = "/fastdata2/data_alex/2011p4_new_fp16/future_36h_average_6h/"
