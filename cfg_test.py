     ...
     #   if cfg['arch'] == "resnet_18":
      ...
      #  elif cfg['arch'] == "avg_mlp":
       ...
       # else:
        ...
        data_root = "/fastdata2/data_alex/2011p4_new_fp16/future_24h_average_none/"
        ...
        sw_datasets = {x: SW_Dataset(EVE_path, data_root, data_root, resolution, cfg['eve_transform'], cfg['eve_sigmoid'], split = x, AIA_transform = aia_transform, crop = crop, flip = flip, crop_res = crop_res, zscore = zscore) for x in ['test']}
