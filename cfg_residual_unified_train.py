...
if __name__ == "__main__":
    ...
    for cfgi,cfgPath in enumerate(cfgs):
        ...
        if cfg['arch'] == "resnet_18":
            ...
            sw_net = alt_models.ChoppedAlexnet64BN(layerCount,14,cfg['dropout'])

        elif cfg['arch'].startswith("anet64"):
            layerCount = int(cfg['arch'].split("_")[1])
            sw_net = alt_models.ChoppedAlexnet64(layerCount,14,cfg['dropout'])
        ...
        EVE_path = "%s/irradiance_10m_residual_alt.npy" % data_root
