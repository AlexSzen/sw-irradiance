...
#    src = "/opt/bigdata/FDL/EVE/np/"
    src = '/home/szenicer/FDL/sw2018-irradiance/EVE'     
    name_eve = 'irradiance_average_none.npy'
    #Where the 6m data should be
    target = '/home/szenicer/FDL/sw2018-irradiance/EVE/eve_future/future_24h_average_none_6m'
    name_future_eve = 'irradiance_future_24h_average_none_6m.npy'
    #Where the AIA data is
    AIA_Base = "/fastdata2/FDL/AIA_256_New/"


    futureJump = datetime.timedelta(hours=24)
    ...
    np.save(target+'/'+name_future_eve,YReind)
